...
const NotFound = () => {
  return (
    <>
      <section className="relative w-full p-36 h-full lg:min-h-[700px] mt-10 mb-8 flex flex-col hide__footer__top">
        <motion.div
          animate={{ opacity: 1 }}
          initial={{ opacity: 0 }}
        ...
        <div className="container relative mx-auto flex flex-col gap-6 justify-center items-center">
          <motion.h1
            ...
            className="text-6xl font-semibold font-open-sans text-center lg:max-w-[810px] leading-[1.2] mt-10"
          >
            {ErrorPage.title}
          </motion.h1>
          <motion.p
            ...
            className="text-center text-lg lg:max-w-[560px] mb-1"
          >
