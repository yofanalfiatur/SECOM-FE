        ...
        <div className="container mx-auto xl:w-[71%]">
          <div className="d-news__content pb-10">
            ...
            <div className="d-news__detail text-lg mb-5">
              <p>
                Cum sociis natoque penatibus et magnis dis parturient. Quo usque
                tandem abutere, Catilina, patientia nostra? Tityre, tu patulae
                recubans sub tegmine fagi dolor. Gallia est omnis divisa in
                partes tres, quarum. Quis aute iure reprehenderit in voluptate
                velit esse. Cum sociis natoque penatibus et magnis dis
                parturient. Quo usque tandem abutere, Catilina, patientia
                nostra? Tityre, tu patulae recubans sub tegmine fagi dolor.
                Gallia est omnis divisa in partes tres, quarum. Quis aute iure
              ...
              <p>
                ...
                Quo usque tandem abutere, Catilina, patientia nostra? Tityre, tu
                patulae recubans sub tegmine fagi dolor. Gallia est omnis divisa
                in partes tres, quarum. Quis aute iure reprehenderit in
              ...
              <ol>
                ...
                <ul>
                  ...
                  <ol>
                    ...
                    <li>
                      Gallia est omnis divisa in partes tres, quarum. Ut enim ad
                      minim veniam, quis nostrud exercitation. Excepteur sint
                      obcaecat cupiditat non proident culpa.
                    </li>
                  </ol>
                  <li>Quo usque tandem abutere, Catilina, patientia nostra?</li>
                </ul>
              ...
              <br></br>
              <h3>
                Heading 3 : Tityre, tu patulae recubans sub tegmine fagi dolor.
              </h3>
              <Image
                src="/img/temp/solutions/sol-bg-2x.jpg"
                width={1000}
              ...
              <br></br>
              <h4>
                Heading 4 : Tityre, tu patulae recubans sub tegmine fagi dolor.
              </h4>
              <blockquote>
                <p>
              ...
              <br></br>
              <h5>
                Heading 5 : Tityre, tu patulae recubans sub tegmine fagi dolor.
              </h5>
              <p>
                Cum sociis natoque penatibus et magnis dis parturient. Quo usque
                tandem abutere, Catilina, patientia nostra? Tityre, tu patulae
      ...
      <section className="d-news__related">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="d-news__list grid lg:grid-cols-3">
            <div className="d-news__item relative lg:px-16 lg:py-16 px-4 py-8 flex flex-col gap-1 lg:gap-4">
              <div className="meta flex flex-row gap-2 items-center uppercase lg:text-sm text-[10px]">
                <p>Category</p> | <p>17 june 2025</p>
              </div>
              <h3 className="text-[25px] lg:text-[30px] font-medium font-raleway leading-snug text-darkblue">
