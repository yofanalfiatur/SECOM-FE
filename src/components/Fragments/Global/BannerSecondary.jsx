...
const BannerSecondary = ({ translationKey }) => {
  const t = useTranslations();
  const BannerSecondary = t.raw(translationKey);
  const isDesktop = useIsDesktop();

  const renderTitle = () => {
    const parts = BannerSecondary.title.split(/(<b>.*?<\/b>)/g);
  ...
  return (
    ...
    >
      <Image
        src={isDesktop ? BannerSecondary.image : BannerSecondary.imageMd}
