          ...
          >
            <SplideTrack className="abw-sustain__track">
              {AbWorldSustain.items.map((item, index) => (
                <SplideSlide
                  key={index}
                  className=" flex flex-col pb-6 lg:pb-15 abw-sustain__slide "
                >
                  <div className="abw-sustain__item bg-white shadow-[0px_2.71px_10.18px_0px_#00000026] lg:shadow-[0px_4px_15px_0px_#00000026] flex flex-col h-full ">
                    <div className="flex flex-col w-full">
                      <Image
                        ...
                        height={291}
                        quality={100}
                        className="w-full h-full object-cover aspect-[285/197] lg:aspect-[420/291] abw-sustain__img"
                      />
                    </div>
