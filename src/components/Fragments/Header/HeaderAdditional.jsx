      ...
      <div className="flex flex-col relative">
        ...
        <div className="bg-navyblue grid grid-cols-2 relative z-[1]">
          <div className="flex flex-col justify-center items-center border-r-[1px] border-[#FFFFFF33] relative header-add__wrap-item">
            <div className="flex flex-row relative items-center justify-center cursor-pointer header-add__item">
              <p className="text-white uppercase tracking-[2px] py-3 px-2 font-raleway">
                {isDesktop
                  ? locale === "en"
                    ? "SECTOR WE PROTECT"
            ...
            {/* triangle */}
            <div className="absolute z-[1] top-full w-[15px] h-[15px] border-t-[15px] border-navyblue border-l-[15px] border-l-transparent border-r-[15px] border-r-transparent scale-[100%]"></div>
          </div>
        ...
        {/* tab content sector */}
        <div className="w-full h-max flex flex-col bg-[#E6E9F5] absolute z-0 top-full left-0">
          <div className="container mx-auto pt-10 lg:pt-9 header-add__content h-[300px] grid grid-cols-12 gap-y-4">
            ...
            <div className="col-span-10 flex flex-col">
              ...
              <ul className="w-full h-full flex flex-col flex-wrap max-h-[165px]">
