...
const CareerBanner = ({ translationKey }) => {
  ...
  return (
    <section className="flex flex-col bg-navyblue relative">
      ...
      <div className="w-full absolute top-1/2 transform -translate-y-1/2 left-0 h-max">
        <div className="container mx-auto flex flex-row-reverse">
          <div className="w-full lg:w-4/12 flex flex-col lg:pl-24 lg:pt-10 lg:pb-10">
            <h2 className="text-white text-[30px] lg:text-[50px] font-raleway font-normal leading-[1.3] lg:leading-[1.2]">
              {CareerBanner.title}
            </h2>
