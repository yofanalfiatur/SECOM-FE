  ...
  return (
    <>
      <motion.div
        ...
        className="flex w-max flex-row items-center gap-4 fixed bottom-[50px] left-1/2 transform translate-x-[-50%] z-[100] bg-[#EAF5FF] opacity-100 py-4 px-8 shadow-[0px_-1px_20px_0px_#0000001A]"
      >
        <div className="bg-[#A70000] flex flex-col rounded-full w-[45px] h-[45px] items-center justify-center">
          <svg
            width="23"
            height="23"
            viewBox="0 0 23 23"
        ...
        <div className="flex flex-col">
          <a
            ...
            className="border-tosca text-tosca hover:bg-tosca hover:text-white transition-all duration-300 ease border-[1px] bg-transparent py-2 px-4 text-sm tracking-[3px] uppercase rounded-[5px]"
          >
            {promoFloat.btn.text}
          </a>
        </div>
