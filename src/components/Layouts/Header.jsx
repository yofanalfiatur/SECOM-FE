...
const Header = () => {
  ...
  return (
    <>
      <header className="flex flex-col items-center justify-center max-w-screen z-[999] top-0 sticky bg-white shadow-sm lg:shadow-none lg:border-b-1 lg:border-[#00529C33] h-[60px] lg:h-full header">
