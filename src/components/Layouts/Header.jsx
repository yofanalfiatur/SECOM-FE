...
const Header = () => {
  ...
  return (
    <>
      <header className="flex flex-col items-center justify-center max-w-screen z-[999] top-0 sticky bg-white border-b-1 border-[#00529C33] h-[60px] lg:h-full header">
        <div className="w-full max-w-screen flex flex-row items-center justify-between header__wrap">
          <div className="w-[220px] items-center flex flex-col justify-center header__logo lg:border-r-1 border-[#00529C33] h-[-webkit-fill-available]">
            <Link
              href="/"
